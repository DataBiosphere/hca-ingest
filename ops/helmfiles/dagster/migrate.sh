...
helm template $HELM_DAGSTER_RELEASE_NAME dagster/dagster --set "migrate.enabled=true" --show-only templates/job-instance-migrate.yaml | kubectl -n dagster apply -f -
