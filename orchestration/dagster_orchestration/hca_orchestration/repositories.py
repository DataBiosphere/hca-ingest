...
from hca_orchestration.pipelines import cut_snapshot, stage_data, validate_egress


@repository
def hca_orchestrationtype() -> list[Union[PipelineDefinition, SensorDefinition]]:
    return [cut_snapshot, postvalidate_on_import_complete, stage_data, validate_egress]
