...
class SolidsTestCase(unittest.TestCase):
    @patch("hca_manage.utils.HcaUtils.get_null_filerefs")
    @patch("hca_manage.utils.HcaUtils.get_file_table_names")
    @patch("hca_manage.utils.HcaUtils.get_duplicates")
    @patch("hca_manage.utils.HcaUtils.get_all_table_names")
