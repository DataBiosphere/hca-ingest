...
def build_new_target_hca_dataset(init_context: InitResourceContext) -> TdrDataset:
    ...
    data_repo_service = init_context.resources.data_repo_service
    result = data_repo_service.find_dataset(target_hca_dataset_name)
