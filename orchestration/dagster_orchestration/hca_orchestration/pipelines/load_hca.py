...
from hca_orchestration.solids.load_hca.stage_data import clear_staging_dir, pre_process_metadata, create_staging_dataset
...
def load_hca() -> None:
    staging_dataset = create_staging_dataset(pre_process_metadata(clear_staging_dir()))
