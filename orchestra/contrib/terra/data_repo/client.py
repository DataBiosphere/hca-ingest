...
from orchestra.contrib.terra.data_repo.api_configuration import RefreshingAccessTokenConfig
...
@resource
def local_terra_data_repo_client(init_context: InitResourceContext) -> LocalDataRepoClient:
